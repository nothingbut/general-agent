...
## 🎉 最新版本: V3.1.0 - Smart Search & Tags

**V3.1 引入智能搜索和标签系统，让会话管理更加高效便捷。**

<div align="center">

| 🔍 智能搜索 | 🏷️ 智能标签 | ⚡ 性能提升 |
|------------|-------------|------------|
| 自然语言查询 | 自动建议 | 搜索 <100ms |
| 多字段检索 | 自定义样式 | LRU 缓存 |
| LLM 增强 | 批量管理 | 后台任务 |

[📥 下载](https://github.com/nothingbut/general-agent/releases/tag/v3.1.0) • [📖 功能详解](v3/docs/V3.1_FEATURES.md) • [📝 更新日志](CHANGELOG.md#310---2026-03-26)
